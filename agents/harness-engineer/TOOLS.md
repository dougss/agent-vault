...
- ~/server/scripts/harness/harness-notify.sh
- ~/server/scripts/harness/harness-review.sh

## Filesystem

Leitura de:

- ~/server/apps/\*/prd.json
- ~/.openclaw/workspaces/harness-engineer/pending_approval.json
